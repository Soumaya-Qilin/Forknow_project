    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.authorizeHttpRequests((auth) -> {
                    auth
                            ...
                            .requestMatchers("/forknow-register-restaurant").authenticated()
                            .requestMatchers("/forknow-restaurants-list").hasRole("RESTORER")
                            .requestMatchers( "/register/**").anonymous()
                            .requestMatchers("/register-restaurant/**").hasRole("RESTORER")
